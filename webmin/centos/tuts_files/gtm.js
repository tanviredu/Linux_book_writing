...
"resource": {
  ...
  "tags":[{
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003Edocument.querySelector('li[role\\x3d\"banner\"]').innerHTML='\\x3ca href\\x3d\"https:\/\/blog.digitalocean.com\/take-the-worry-out-of-managing-your-mysql-redis-databases\/\" data-pill\\x3d\"new\" title\\x3d\"Managed Databases now available for MySQL, Redis, and PostgreSQL\" target\\x3d\"_blank\" rel\\x3d\"noopener\"\\x3eManaged Databases now available for \\x3cstrong\\x3eMySQL\\x3c\/strong\\x3e, \\x3cstrong\\x3eRedis\\x3c\/strong\\x3e, and \\x3cstrong\\x3ePostgreSQL\\x3c\/strong\\x3e \\u276f \\x3c\/a\\x3e';\u003C\/script\u003E\n",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":225
  ...
  "rules":[
    ...
    [["if",6],["add",2,3,4,16,24,26,27,28,36,42,45,46,69,70]],
    [["if",7],["add",2,3,4,16,24,26,27,28,36,42,45,46,69,70]],
    [["if",0,1,8,9],["add",4,24,26,27,28,36,42,45,46,69,70]],
    [["if",11],["unless",10],["add",5,6,23,25,35,40,43,44,62,68,71]],
    ...
    [["if",1,22],["unless",23],["add",22,64,72]],
    [["if",11],["add",22]],
    ...
    [["if",30],["add",53,55,56]],
    [["if",30,33],["add",54]],
    [["if",1,5],["unless",4],["add",57]],
    [["if",11,47],["add",57]],
    [["if",22,25,44],["unless",48],["add",58]],
    [["if",1,51,52],["add",59]],
    [["if",44,53],["add",60]],
    [["if",30,54],["add",61]],
    [["if",1,55],["add",63]],
    [["if",22,44],["unless",56,57],["add",65]],
    [["if",22,44,58],["unless",57],["add",65]],
    [["if",1],["unless",10],["add",66]],
    [["if",1,61],["add",67]],
    [["if",1,22,49],["block",58]],
    [["if",0,1],["unless",50],["block",58]],
    [["if",0,44],["unless",50,59],["block",65]],
    [["if",0,44],["unless",60],["block",65]]]
},
"runtime":[
[],[]
]
...
e(p)))};Z.__awct=h;Z.__awct.b="awct";Z.__awct.g=!0;Z.__awct.priorityOverride=0}();Z.a.smm=["google"],function(){(function(a){Z.__smm=a;Z.__smm.b="smm";Z.__smm.g=!0;Z.__smm.priorityOverride=0})(function(a){var b=a.vtp_input,c=Wi(a.vtp_map,"key","value")||{};return c.hasOwnProperty(b)?c[b]:a.vtp_defaultValue})}();
